...
__all__ = ['SqueezeNetDSC', 'squeezenetdsc1_0', 'squeezenetdsc1_1']
...
class SqueezeNetDSC(nn.Module):

    def __init__(self, version=1.0, num_classes=10):
        super(SqueezeNetDSC, self).__init__()
...
def squeezenetdsc1_0(**kwargs):
    model = SqueezeNetDSC(version=1.0, **kwargs)
    print(model)
    return model


def squeezenetdsc1_1(**kwargs):
    model = SqueezeNetDSC(version=1.1, **kwargs)
    return model
