...
class DatasetFolder(data.Dataset):
    ...
    def __init__(self, root, loader, extensions, transform=None, target_transform=None, selected_classes=None):
        ...
        if selected_classes is not None:
            samples = [item for item in samples if item[1] in selected_classes]
        # end of path code...
